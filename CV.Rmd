...
tribble(~Date, ~What, ~Descr, ~With,
        '11/2017 - Current', 'PhD Student at The Laboratory of Computational Metagenomics – CIBIO, UniTN', 'Descrtiption', 'P.I. Dr. Nicola Segata',
...
'Francesco Asnicar, Francesco Beghini, Claudia Mengoni, Paolo Manghi, Qiyun Zhu, Mattia Bolzan, Fabio Cumbo, Uyen May, Jon G. Sanders, Serena Manara, Moreno Zolfo, Evguenia Kopylova, Edoardo Pasolli, Rob Knight, Siavash Mirarab, Curtis Huttenhower, Nicola Segata', 'Precise phylogenetic analysis of microbial isolates and genomes from metagenomes using PhyloPhlAn2', 'Nature Communications'
) %>% 
